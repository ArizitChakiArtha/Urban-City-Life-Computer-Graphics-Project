// scene3.cpp — Sunset to Night City (standalone)
// Build (Code::Blocks / MinGW): link with glut32, glu32, opengl32
...
void drawScene3SilhouetteBoat() {
    ...
    glVertex2d(sunsetBoat + 172, 295);
    glVertex2d(sunsetBoat + 172, 240);
    glVertex2d(sunsetBoat + 222, 240);
    glEnd();
}
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Scene 3 — Sunset to Night City");
